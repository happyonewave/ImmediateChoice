...
//    private StandardGSYVideoPlayer gsyVideoPlayer_right;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.view_circle_item, null);
            holder.view_item_img_layout = (LinearLayout) convertView.findViewById(R.id.view_item_img_layout);
            ...
            holder.image_text_item_img_left = (ImageView) convertView.findViewById(R.id.image_text_item_img_left);
            holder.image_text_item_img_right = (ImageView) convertView.findViewById(R.id.image_text_item_img_right);
...
//        holder.right_ProgressBar.setProgress(0);
        ...
        if (i.getLeft_url().contains("/image/")) {
            ...
            holder.gsyVideoPlayer_left.setVisibility(View.GONE);
            holder.gsyVideoPlayer_right.setVisibility(View.GONE);
            holder.tpv_left.setVisibility(View.GONE);
            holder.tpv_right.setVisibility(View.GONE);
            Glide.with(context).load(i.getLeft_url()).into(holder.image_text_item_img_left);
            Glide.with(context).load(i.getRight_url()).into(holder.image_text_item_img_right);
...
//        holder.gsyVideoPlayer_right.setImageBitmap(utils.createVideoThumbnail(i.getLeft_url()));
        ...
        if (i.getPortrait_url() != null) {
            ...
            Glide.with(context).load(i.getPortrait_url())
                    .bitmapTransform(new CropCircleTransformation(context))
                    .into(holder.item_portrait);
...
//        ImageView share_icon;
     ...
     * @param question_id
     */
    public void likeThis(final ViewHolder holder, final String type, int question_id) {
        RequestParams entity = new RequestParams(Config.url_comment);
        entity.addBodyParameter("msg", CHOICE_ONE);
