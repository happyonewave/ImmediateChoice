...
//        home_attention_refreshLayout.setHeaderView(sinaRefreshView);
        //监听下拉，上拉事件
        home_attention_refreshLayout.setOnRefreshListener(new RefreshListenerAdapter() {
            ...
            public void onRefresh(TwinklingRefreshLayout refreshLayout) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        home_attention_refreshLayout.finishRefreshing();
                    }
                }, 2000);
            ...
            public void onLoadMore(TwinklingRefreshLayout refreshLayout) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        home_attention_refreshLayout.finishLoadmore();
                    }
                }, 2000);
        ...
        protected void onPostExecute(String id) {
            if (id != "0") {
                ...
                ShowFromJsonArrayTask showFromJsonArrayTask =
                        new ShowFromJsonArrayTask(context, lv_home_attention, url, questiobId);
        ...
        protected void onPostExecute(String request) {
            if (request != null) {
                ...
                if (!request.equals("-1")) {
                    ...
                    lv_home_attention.setAdapter(adpter);
                } else {
